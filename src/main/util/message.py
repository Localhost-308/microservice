...
ERROR_LOGIN_VALIDATION = "Ocorreu um erro ao validar seu usuário. Tente novamente em alguns minutos."

# Portabilidade
ERROR_PORTABILITY_DATA_FETCH = "Ocorreu um erro ao obter suas informações. Tente novamente em alguns minutos."